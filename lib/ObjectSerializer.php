...
use Subugoe\CounterClient\Model\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (strpos($class, 'map[') === 0) { // for associative array e.g. map[string,int]
        ...
        if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
            $subclass = '\Subugoe\CounterClient\Model\\' . $data->{$discriminator};
